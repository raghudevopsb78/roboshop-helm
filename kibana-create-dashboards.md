## Got the JSON file here
``````
curl -u 'elastic:xxxx' -X GET "https://kibana-dev.rdevops6a.online/api/kibana/dashboards/export?dashboard=942dcef0-b2cd-11e8-ad8e-85441f0c2e5c" -H 'kbn-xsrf: true'
```
### Importing the json file

```
curl -u 'elastic:xxxx' -X POST "https://kibana-dev.rdevops6a.online/api/kibana/dashboards/import?exclude=index-pattern" -H 'kbn-xsrf: true' -H 'Content-Type: application/json' -d'
{
  "version": "8.14.0",
  "objects": [
    {
